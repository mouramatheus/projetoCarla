	...
	<div class="container">
		<form method="POST">
	  		<div class="form-group">
	    		...
	    		<input type="text" name="nomeMedico" class="form-control" placeholder="Nome do médico" required>
	  		</div>

	  		<div class="form-group">
	    		<label>CRM</label>
	    		<input type="number" name="crmMedico" class="form-control" placeholder="CRM do médico" required>
	  		</div>
		...
		<?php 
			if(isset($_POST['acao'])){
				$sql = $pdo->prepare("INSERT INTO med (MED_NOME, MED_CRM) VALUES (:NOME,:CRM)");
