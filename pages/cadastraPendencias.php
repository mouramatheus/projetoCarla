...
<head>
	...
	<title>Cadastra Pendências</title>
	...
	<div class="container">
		<form method="POST">
	  		<div class="form-group">
	    		<label>Digite o tipo da pendência</label>
	    		<input type="text" name="nomePendencia" class="form-control" placeholder="Pendências" required>
	  		</div>
		...
		<?php 
			if(isset($_POST['acao'])){
				$sql = $pdo->prepare("INSERT INTO pend (PEND_DESC) VALUES (:PENDENCIA)");
				$pendencia = $_POST['nomePendencia'];
				$sql->bindParam(":PENDENCIA",$pendencia);
				if($sql->execute() === false){
					print_r($sql->errorInfo());
				}
				else{?>
					<script type="text/javascript">alert("Cadastrado Pendencia")</script>
					<?php
				}	
			}
