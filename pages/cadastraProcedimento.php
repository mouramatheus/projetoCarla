...
<meta charset="utf-8">
	...
	<title>Cadastra Procedimento</title>
	...
	<div class="container">
		<form method="POST">
	  		<div class="form-group">
	    		...
	    		<input type="text" name="nomeProcedimento" class="form-control" placeholder="Nome do procedimento" required>
	  		</div>

	  		<div class="form-group">
	    		<label>Código do Procedimento</label>
	    		<input type="number" name="codProcedimento" class="form-control" placeholder="Código do Procedimento" required>
	  		</div>
		...
		<?php 
			if(isset($_POST['acao'])){
				$sql = $pdo->prepare("INSERT INTO proc (PROC_COD, PROC_DESC) VALUES (:COD,:NOME)");
				$codProcedimento = $_POST['codProcedimento'];
				$nomeProcedimento = $_POST['nomeProcedimento'];
				$sql->bindParam(":COD",$codProcedimento);
				$sql->bindParam(":NOME",$nomeProcedimento);
